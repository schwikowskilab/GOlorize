...
public class StartPanel extends javax.swing.JPanel{
    ...
    public StartPanel(GOlorize goB,final CySwingAppAdapter adapter) {
        this.jTabbedPane=new javax.swing.JTabbedPane();
        
        this.goBin=goB;     
        this.adapter = adapter;
        this.appMgr = adapter.getCyApplicationManager();
        initComponents();
   ...
   //     //jPanelDeBase.add(new JLabel(" on me vois ou pas ?"),java.awt.BorderLayout.SOUTH);
        ...
        tabAll = new StartPanelPanel(goBin,StartPanelPanel.ALLTYPE,adapter,appMgr);
        jTabbedPane.addTab("       All        ",tabAll);
        
        
        tabBioProcess = new StartPanelPanel(goBin,StartPanelPanel.BPTYPE,adapter,appMgr);
        jTabbedPane.addTab("Biological Process",tabBioProcess);
        
        
        tabCellComponant = new StartPanelPanel(goBin,StartPanelPanel.CCTYPE,adapter,appMgr);
        jTabbedPane.addTab("Cellular Component",tabCellComponant);
        
        
        tabMolFunction = new StartPanelPanel(goBin,StartPanelPanel.MFTYPE,adapter,appMgr);
        jTabbedPane.addTab("Molecular Function",tabMolFunction);     
        
        
        tabOther = new StartPanelPanel(goBin,StartPanelPanel.OTHERTYPE,adapter,appMgr);
