...
public class StartPanelPanel extends javax.swing.JPanel implements ResultAndStartPanel {
    ...
    public StartPanelPanel(GOlorize goB,String type,final CySwingAppAdapter adapter, CyApplicationManager appMgr) {
        this.goBin = goB;
        this.type=type;
     ...
     void initComponents (){
        ...
        coloredColumn.setCellRenderer(new ColorRenderer(false,this.getGOlorize().getGoColor(), this));
        ...
        displayPieChartListener = new DisplayPieChart2(this, this.goBin.getNetwork_Options(),appMgr);
        ...
        automaticColorsButton.addActionListener(new ActionListener() {
                        public void actionPerformed (ActionEvent e){
                            ...
                            displayPieChartListener.doIt(displayPieChartListener.APPLY_CHANGE,true,appMgr.getCurrentNetworkView());
                            goBin.synchroColor();
                        }
                    });
    ...
    void removeTermOfAllCyNetworkView(String term){
        ...
        while (it.hasNext()){
            CyNetworkView cnv = (CyNetworkView)it.next();
    ...
    private void chooseNewTerm(){
        ...
        OntologyTerm ontTerm = ont.getTerm(termInt);
        if (ontTerm==null){
