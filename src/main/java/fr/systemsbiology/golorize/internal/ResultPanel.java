...
import fr.systemsbiology.golorize.internal.BiNGO.SignificantFigures;
...
public class ResultPanel extends JPanel implements ResultAndStartPanel {
	...
	public ResultPanel(Map testMap, Map correctionMap, Map mapSmallX, Map mapSmallN, Map mapBigX,
			...
			Set selectedCanonicalNameVector, CyNetwork currentNetwork, CyNetworkView currentNetworkview, GOlorize goB, final CySwingAppAdapter adapter) {
	...
	void initComponents() {
		...
		displayPieChartListener = new DisplayPieChart2(this, this.goBin.getNetwork_Options(),adapter.getCyApplicationManager());
